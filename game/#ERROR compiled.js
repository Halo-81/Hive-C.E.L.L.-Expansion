...
(function() {
  ...
  add(Meattoilet = (function(superClass) {
    ...
    Meattoilet.prototype.description = function() {
      return "This is what happen when a Holy girl trampleded as men plaything after being gangbanged and edged for... idk.";
    };

    Meattoilet.prototype.image = Person.sticky;

    Meattoilet.images = ['Alice/1'];
  ...
  add(TFMeattoilet = (function(superClass) {
    ...
    TFMeattoilet.prototype.lust = 101;
    ...
    TFMeattoilet.prototype.description = function() {
      return "When former patriach man magically transform into women, they trampled as men plaything. Even, in most case, they still deviant (or maybe they acting though so we feel breaking Her?). Thats why full restraining is quite handy";
    };

    TFMeattoilet.prototype.image = Person.sticky;

    TFMeattoilet.images = ['Alice/2'];
...
(function() {
  ...
  add(AuctionHouse = (function(superClass) {
    ...
    AuctionHouse.prototype.people = {
      ...
      Merchandise: {
        isnt: [Person.DarkLady, Person.Liana, Person.Alice]
      }
    };
...
(function() {
  ...
  whoreDepravity = function(context) {
    var lust, ref, ref1, ref2;
    lust = (((ref = context.w1) != null ? ref.lust : void 0) || 0) + (((ref1 = context.w2) != null ? ref1.lust : void 0) || 0) + (((ref2 = context.w3) != null ? ref2.lust : void 0) || 0);
